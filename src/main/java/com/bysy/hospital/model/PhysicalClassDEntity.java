...
@Entity
@Table(name = "physical_class_d")
public class PhysicalClassDEntity implements Serializable {
    private int physicalClassDId;
    ...
    @Id
    @GeneratedValue
    @Column(name = "physical_class_d_id", nullable = false, insertable = true, updatable = true)
    public int getPhysicalClassDId() {
        return physicalClassDId;
    }

    public void setPhysicalClassDId(int physicalClassDId) {
