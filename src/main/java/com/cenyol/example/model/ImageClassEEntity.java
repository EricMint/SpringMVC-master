...
@Entity
@Table(name = "image_class_e")
public class ImageClassEEntity implements Serializable {
    ...
    @Id
    @GeneratedValue
    @Column(name = "image_class_e_id", nullable = false, insertable = true, updatable = true)
