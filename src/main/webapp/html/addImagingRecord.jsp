...
<div class="container">
    ...
    <form:form action="/addImagingRecordPost" method="post" role="form">
        ...
        <div class="form-group">
            <label for="imagingExaminationCategoryName">影像检查部位:</label>
            <select id="imagingExaminationCategoryName" name="imagingExaminationCategoryName">
                <option value="">请选择</option>
                <option value="全脊柱">全脊柱</option>
        ...
        <div class="form-group">
            ...
            <select id="imagingExaminationItemName" name="imagingExaminationItemName">
                <option value="">请选择</option>
