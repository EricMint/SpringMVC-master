    ...
    <form:form action="/hospital/physicalRecord/updatePost" method="post" role="form">
        ...
        <div class="form-group">
            ...
            <select id="physicalClassAId" name="physicalClassAId" data-placeholder="请选择" onchange="initClassB(this.value);">
                ...
                <c:forEach items="${physicalClassAList}" var="physicalClassA">
                    <c:if test="${physicalRecord.physicalClassAName == physicalClassA.physicalClassAName}">
                        <option value="${physicalClassA.physicalClassAId}" selected="selected">${physicalClassA.physicalClassAName}</option>
                    </c:if>
                    <c:if test="${physicalRecord.physicalClassAName != physicalClassA.physicalClassAName}">
        ...
        <div class="form-group">
            ...
            <select id="physicalClassBId" name="physicalClassBId" data-placeholder="请选择" onchange="initClassC(this.value);">
                <c:forEach items="${physicalClassBList}" var="physicalClassB">
                    <c:if test="${physicalRecord.physicalClassBName == physicalClassB.physicalClassBName}">
                        <option value="${physicalClassB.physicalClassBId}" selected="selected">${physicalClassB.physicalClassBName}</option>
                    </c:if>
                    <c:if test="${physicalRecord.physicalClassBName != physicalClassB.physicalClassBName}">
                        <option value="${physicalClassB.physicalClassBId}">${physicalClassB.physicalClassBName}</option>
                    </c:if>
                </c:forEach>
            </select>
        </div>
        <div class="form-group">
            ...
            <select id="physicalClassCId" name="physicalClassCId" data-placeholder="请选择" onchange="initClassD(this.value);">
                <c:forEach items="${physicalClassCList}" var="physicalClassC">
                    <c:if test="${physicalRecord.physicalClassCName == physicalClassC.physicalClassCName}">
                        <option value="${physicalClassC.physicalClassCId}" selected="selected">${physicalClassC.physicalClassCName}</option>
                    </c:if>
                    <c:if test="${physicalRecord.physicalClassCName != physicalClassC.physicalClassCName}">
        ...
        <div class="form-group">
            ...
            <select id="physicalClassDId" name="physicalClassDId" data-placeholder="请选择" onchange="initClassE(this.value);">
                <c:forEach items="${physicalClassDList}" var="physicalClassD">
                    <c:if test="${physicalRecord.physicalClassDName == physicalClassD.physicalClassDName}">
                        <option value="${physicalClassD.physicalClassDId}" selected="selected">${physicalClassD.physicalClassDName}</option>
                    </c:if>
                    <c:if test="${physicalRecord.physicalClassDName != physicalClassD.physicalClassDName}">
                        <option value="${physicalClassD.physicalClassDId}">${physicalClassD.physicalClassDName}</option>
                    </c:if>
                </c:forEach>
            </select>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="result" name="result" value="${physicalRecord.result}" placeholder="请输入测量数值:"/>
        </div>
